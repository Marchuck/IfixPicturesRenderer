...
import pl.marczak.ifixpicturesrenderer.model.AuxiliaryObjects;
import pl.marczak.ifixpicturesrenderer.model.Binding;
import pl.marczak.ifixpicturesrenderer.model.Bindings;
import pl.marczak.ifixpicturesrenderer.model.DataConnectors;
...
public class PumpForeignObject {
    public static final String TAG = PumpForeignObject.class.getSimpleName();
